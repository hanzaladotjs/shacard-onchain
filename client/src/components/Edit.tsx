...
export default function Edit({ cardRef }: any) {
    ...
    return (
        <div
            className="w-[440px] hover:scale-[1.1] h-[550px] shadow shadow-[0_0_30px_rgba(22,101,52,0.7)] rounded-xl border-[2px] border-[#6b21a8] bg-[#e4ffff] font-sans font-semibold flex flex-col items-center"
            ref={cardRef}
        >
            ...
            <div className="flex flex-col space-y-1 items-center">
                <div>
                    <img
                        src={pfp}
                        className="border-[5px] mt-5 border-[#759f75] rounded-xl h-60 w-60"
                        alt=""
                    />
                </div>
            ...
            <div className="flex ml-15 w-70 mt-5 flex-wrap space-x-10 text-[#000000] text-center">
            ...
            <div className="text-sm ml-15 text-[#000000] flex justify-center w-90 mt-4">
